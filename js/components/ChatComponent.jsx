...
function ChatComponent(props) {
	...
	return (
		<div className={"w-full max-w-[1500px] mx-auto my-10"}>
			<div className={"border border-b-0 rounded-lg border-pink-400'"}>
				<div className={'border-b text-center px-[20px] py-[10px]'}>
					<span className={'text-md font-bold text-purple-950'}>
						Aceasta componenta arata ca Yahoo Mail!
					</span>
				</div>
			...
			<input
				id={'chat-input'}
				type={'text'}
				className="bg-purple-50 border border-pink-200 border-x-0 text-purple-950 text-sm rounded-lg focus:ring-pink-400 focus:border-pink-400 block w-full p-4"
